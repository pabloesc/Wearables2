# Codebook for runAnalysis.R: Average dataset
@pabloesc

Average dataset is the result of several cleaning and tidying jobs in R from file: https://d396qusza40orc.cloudfront.net/getdata%2Fprojectfiles%2FUCI%20HAR%20Dataset.zip 
...
ID for subject that collected data.
Numeric Values 1-30
- "activity": 

label describing activities done during data recording. Factors value: 
LAYING SITTING STANDING WALKING WALKING_DOWNSTAIRS WALKING_UPSTAIRS

- Average (mean) and Standard deviations (std) of Measurements of the wearables: Numeric values:
- tBodyAcc-mean()-X              : num  0.222 0.261 0.279 0.277 0.289 ...
- tBodyAcc-mean()-Y              : num  -0.04051 -0.00131 -0.01614 -0.01738
...
- tGravityAccMag-mean()          : num  -0.8419 -0.9485 -0.9843 -0.137 0.0272 ... - tBodyAccJerkMag-mean()         : num  -0.9544 -0.9874 -0.9924 -0.1414 -0.0894 ...
...
average dataset from RunAnalysis.R script
